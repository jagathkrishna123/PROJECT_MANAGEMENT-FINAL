...
const StudentNotification = () => {
  ...
  console.log(filteredNotifications, "filte");
        ...
        {filteredNotifications.length === 0 ? (
          ...
          filteredNotifications.map((notification) => (
            <div
              ...
              className={`bg-white rounded-2xl shadow-lg border transition-all duration-200 hover:shadow-xl cursor-pointer ${notification.read ? 'border-slate-200/60' : `border-2 ${getNotificationTypeColor(notification.type)}`
                }`}
