                ...
                <div className="flex items-center justify-between px-4 lg:px-8 h-16">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            className="p-2 -ml-2 text-slate-600 hover:text-blue-600 md:hidden transition-colors"
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="hidden lg:block text-left">
                                <p className="text-slate-800 font-semibold text-sm leading-none mb-1">
                                    {user ? user.name : 'Student'}
                                </p>
                                <p className="text-slate-500 text-xs leading-none">
                                    {user ? `${user.department} • Student` : 'student dashboard'}
                                </p>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={logout}
                            className="inline-flex items-center px-3 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        >
            ...
            <div className="flex h-[calc(100vh-4rem)] relative overflow-hidden">
                ...
                <main className="flex-1 overflow-hidden">
                    <div className="h-full overflow-y-auto bg-slate-50/30">
                        <div className="p-2 sm:p-6 lg:p-8 min-h-full">
                            <Outlet />
                        </div>
                    </div>
                </main>
